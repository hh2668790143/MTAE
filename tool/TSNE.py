...
def do_tsne(latent, true_labels, model=None, dataset=None, display=True, classes=None, seed=None):
    ...
    if display:
        ...
        plt.savefig('./Plot_Tsne/{}_{}_{}_{}.svg'.format(model, dataset, classes, seed), transparent=False,
...
def do_tsne_sns(latent, true_labels, opt, display=False):
    ...
    if display:
        ...
        plt.savefig('./Plot_TSNE/{}/{}_{}_{}.svg'.format(opt.model, opt.dataset, opt.normal_idx, opt.seed), transparent=False,
                    bbox_inches='tight')
        # plt.savefig(directory + 'histogram_{}_{}.pdf'.format(random_seed, dataloader),
        #             transparent=False, bbox_inches='tight')
        plt.close()
